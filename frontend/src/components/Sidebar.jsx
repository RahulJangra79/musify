...
import { Musify_Logo } from "../assets";
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#000] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${
